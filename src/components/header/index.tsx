            ...
            <C.Nav display={handleNav(handleNavState)}>
                <C.AllItems>
                    ...
                    <C.ListAll display={handleNav(handleNavListState)}>
                        <li><Link to="/categories/Mercearia">Mercearia</Link></li>

                        <li><Link to="/categories/Açucar">Açucar e Adoçante</Link></li>

                        <li><Link to="/categories/Massas&Molhos">Massas e Molhos</Link></li>

                        <li><Link to="/categories/Doces&Confeitaria">Doces e Confeitaria</Link></li>

                        <li><Link to="/categories/Hortifruti">Hortifruti</Link></li>
                        
                        <li><Link to="/categories/Notebooks">Notebooks</Link></li>
                        <li><Link to="/categories/Eletrodomesticos">Eletrodomésticos</Link></li>
